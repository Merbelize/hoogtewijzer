...
function buildResult({
  ...
  return {
    ...
    disclaimer:
      "Dit is een hulpmiddel. Stop bij twijfel en laat je leidinggevende of veiligheidskundige meekijken."
  };
}
...
export function buildFallbackAdvice(result) {
  ...
  const action =
    result.checks[0] || result.measures[0]
      ...
      : "";
  return `${opening}${why}${action} Vraag hulp bij twijfel. Zo werk je rustiger en veiliger.`;
}
