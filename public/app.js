...
async function askAi() {
  ...
  button.textContent = "AI denkt mee...";
  showAiAnswer("Een ogenblik, het AI-advies wordt opgesteld.", "AI-advies wordt gemaakt");
  try {
    ...
    const heading = data.mode === "ai" ? "AI-advies" : "Basisadvies - AI niet actief";
    ...
    button.textContent = "Maak AI-advies";
  }
}
